...
public class Loan extends BaseEntity {
    ...
    private com.sih.module.group.entity.BorrowerGroup group;

    @Column(name = "is_group_loan")
    @Builder.Default
    private Boolean isGroupLoan = false;
    ...
    @Column(name = "accumulated_interest", precision = 15, scale = 2)
    @Builder.Default
